...
IUSE="aac +alsa ao audiofile bzip2 cdio +curl debug +dumb +fifo +ffmpeg flac
...
INPUT_PLUGINS="aac audiofile dumb ffmpeg flac fluidsynth mad mikmod modplug mpg123
